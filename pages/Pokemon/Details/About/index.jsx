...
import Icon from 'react-native-vector-icons/Foundation'; // Replace 'FontAwesome' with the icon library you are using (e.g., 'MaterialIcons', 'Ionicons', etc.)
import {
  Section,
  SectionTitle,
  SectionContent,
...
import getPokemonGenderStats from '../../../../utils/getGenderByPokemonType';
